                                        ...
                                        <g:form controller="dashboard" action="linkRes" name="linkResource" params="[id: usr]">
                                            <div class="container" style="padding:10px">
                                                ...
                                                <div class="modal-footer">
                                                    <g:submitButton name="create-topic" value="Share"  class="submit btn btn-primary" style="float: right; margin-right: 4px;" onclick="document.getElementById('Modal-topic').style.display='none'"/>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4" href="#">
                                                        <g:if test="${!(company.Subscription?.findByTopicAndUser(it,usr)?.user?.id==usr.id)}">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <g:form controller="dashboard" action="invitation" name="invite" params="[id: usr]">
                                                                                                    <div class="container" style="padding:10px">
                                                                                                        ...
                                                                                                        <br>
                                                                                                        <div class="modal-footer">
                                                                                                            <g:submitButton name="create-topic" value="Invite"  class="submit btn btn-primary" style="float: right; margin-right: 4px;" onclick="document.getElementById('Modal-topic').style.display='none'"/>
                                                                                                            <input type="button" value="Cancel" class="submit btn btn-primary" data-dismiss="modal" style="float:right; margin-right:4px;" >
