                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4" href="#">
                                                        <g:if test="${it.topic.createdBy.id==usr.id}">
                                                            %{--<g:if test="${sub.id!=}">--}%
                                                                %{--<g:link controller="subscription" action="subscribe" params="[]">Subscribe</g:link>--}%
                                                            %{--</g:if>--}%
                                                            %{--<g:else>--}%
                                                                %{--<g:link controller="subscription" action="unsubscribe" params="[]">Unsubscribe</g:link>--}%
                                                            %{--</g:else>--}%
                                                        </g:if>
                                                        <g:else test="${(it.topic.createdBy.id==usr.id)}">
                                    ...
                                    <g:if test="${!(it.createdBy.id==usr.id)}">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4" href="#">
                                                            <g:if test="${!(Subscription.findByTopic(it).user.id==usr.id)}">
                        ...
                        <div class="card-body" id="row1">
                            <div class="media">
                                <g:each in="${company.Resources.list()}" var="val">
                                    <g:if test="${!company.ReadingItem.findByResourceAndUser(val,usr) && !(usr.id==val.user.id)}">
                                        <div class="row">
                                            <div class="col-md-3">
