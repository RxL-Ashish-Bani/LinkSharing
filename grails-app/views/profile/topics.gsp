                        ...
                        <div class="card-body" id="row1">
                            <div class="media">
                                <g:each in="${company.Topic.list()}">
                                    <g:if test="${it.topicName==top.topicName}">
                                        <div class="row">
                                            <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <h6>${company.Topic.countByCreatedBy(it.user)}</h6>
                                                    </div>
                                                    <div class="col-md-4">
                                                    </div>
                                                </div>
                        ...
                        <div class="card-body" id="row1">
                            <div class="media">
                                <g:each in="${company.Resources.list()}">
                                    <g:if test="${(it.topic.id==top.id)}">
                                        %{--<g:if test="${!(company.ReadingItem.findByResourceAndUser(it,usrId)) && (company.Subscription?.findByTopic(it.topic)?.user?.id==usrId.id) && !(it.user.id==usrId.id)}">--}%
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <g:if test="${it.user.photo!=null}">
                                                        <asset:image src="/Photos/${it.user.userName}.png" class="media-object1"/>
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="row">
                                                                ...
                                                                %{--<g:if test="${it.user.id!=usrId.id}">--}%
                                                                    %{--<g:link controller="readingItem" action="read" params="[rid: it.id,uid: it.user.id]" class="col-md-3">--}%
                                                                        %{--Mark as read--}%
                                                                    %{--</g:link>--}%
                                                                %{--</g:if>--}%
                                                                <br>
